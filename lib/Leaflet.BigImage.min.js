  ...
  (t.Control.BigImage = t.Control.extend({
    ...
    onAdd: function (t) {
      ...
      let n = this.options.printControlClasses;
        console.log('ON ADD in print');
        window.mapPrinter = this;
      return (
        -1 != i.indexOf("&") && n.push(this.options._unicodeClass),
          ...
          new Promise((n) => {
            try {
              e instanceof t.Marker && e._icon && e._icon.src
                ...
                ? (i.circles[e._leaflet_id] || (i.circles[e._leaflet_id] = e),
                  n())
                : e instanceof t.Path
                ? i._getPathLayer(e, n)
                : n();
    ...
    _getMarkerLayer: function (e, i) {
      ...
      if (
        ...
        e.options.icon &&
          e.options.icon.options &&
          e.options.icon.options.iconAnchor &&
          ((o.x -= e.options.icon.options.iconAnchor[0]),
          (o.y -= e.options.icon.options.iconAnchor[1])),
    ...
    _getPathLayer: function (e, i) {
      ...
      !e._mRadius && e._latlngs
        ? ((e.options.fill ? e._latlngs[0] : e._latlngs).forEach((e) => {
            ...
            (i = i.subtract(new t.Point(n.bounds.min.x, n.bounds.min.y))),
              s.push(i),
              i.x < n.canvas.width && i.y < n.canvas.height && (o = 1);
          }),
          o &&
            (n.path[e._leaflet_id] = {
              parts: s,
              closed: e.options.fill,
              options: e.options,
            }),
          i())
        : i();
    ...
    _feelPath: function (t) {
      t.fill &&
        ((this.ctx.globalAlpha = t.fillOpacity),
        (this.ctx.fillStyle = t.fillColor || t.color),
        this.ctx.fill(t.fillRule || "evenodd")),
        t.stroke &&
          0 !== t.weight &&
          (this.ctx.setLineDash &&
            this.ctx.setLineDash((t && t._dashArray) || []),
          ...
          .then(
            () =>
              new Promise((e, i) => {
                ...
                for (const [e, i] of Object.entries(t.markers))
                  t.ctx.drawImage(i.img, i.x, i.y);
                for (const [e, i] of Object.entries(t.circles))
                  t._drawCircle(i);
                e();
              })
          )
          .then(() => {
            t.canvas.toBlob(function (t) {
              ...
              (e.download = "bigImage.png"),
                ...
                localStorage.setItem('map_data_url', URL.createObjectURL(t));
            }),
